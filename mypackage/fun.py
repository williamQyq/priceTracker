import selenium
from mypackage.module import pd, config, datetime
from mypackage.module import load_workbook, WebDriverWait, EC, By
...
def auto_purchase(driver):
    ...
    try:
        ...
        print(f"[Status]: === purchase Order start, adding to cart === ")
         ...
         print("[Failure]: === unable to add to cart ===")
...
def track_instock_price(df, driver):
